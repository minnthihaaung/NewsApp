...
class GetNewsArticlesAsFlowUseCase @Inject constructor(private val newsArticleRepository: NewsArticleRepository) :
  FlowUseCase<Unit, List<NewsArticle>>() {

  override fun provide(params: Unit): Flow<List<NewsArticle>> {
    return newsArticleRepository.getNewsArticlesAsFlow()
  }
}